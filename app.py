...
with st.sidebar:
    ...
    st.markdown("---")
    st.markdown("👨‍💻 Developed by: ** Akshat Gupta **")
    st.markdown("🔗 GitHub: [Akshat Gupta](https://github.com/akshat142005)")
    st.markdown("🔗 LinkedIn: [Profile](https://www.linkedin.com/in/akshat-gupta-6a6717292/)")
    st.markdown("---")
...
# background image
image = Image.open('background img 2025-11-18 at 6.19.13 PM.jpeg')
